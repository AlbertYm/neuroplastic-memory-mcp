...
#define CBM_STORE_BUSY (-4)
#define CBM_STORE_TIMEOUT (-5)
#define CBM_STORE_RECOVERY_REQUIRED (-6)
#define CBM_STORE_BACKUP_VERIFY_FAILED (-7)

/* Stable machine-readable result names used by MCP/evidence surfaces. */
...
/* ── Local-fork memory/ADR extensions ── */
